...
public enum MessageSqlEnum {
    ...
    CREATE_MESSAGE(
            "CREATE TABLE IF NOT EXISTS `gp_message`  (" +
                    ...
                    "`joinMessage` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL," +
                    "`quitMessage` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL," +
